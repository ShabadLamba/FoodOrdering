...
def insertOneRestaurant(restaurant_id,name,url,address,locality_id,latitude,longitude,rating,country_id,phone,timings,average_cost_for_two,is_pure_veg,\
	...
	query = "INSERT INTO restaurants(restaurant_id,name,url,address,locality_id,latitude,longitude,rating,country_id,phone,timings,average_cost_for_two,is_pure_veg,\
			sports_bar_flag,has_bar,has_ac,has_dine_in,has_delivery,takeaway_flag,accepts_credit_cards,accepts_debit_cards,\
			sheesha_flag,halal_flag,has_wifi,has_live_music,nightlife_flag,stag_entry_flag,entry_fee,has_online_delivery,\
			min_order,average_delivery_time,delivery_charge,accepts_online_payment,) "\
